#ifndef SIMPLE_FAN_CONTROL_META_H
#define SIMPLE_FAN_CONTROL_META_H
...
class FanControl : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<FanControl> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<FanControl> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "FanControl";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "simple.Fan Control";
    ...
    static const aos::jack::MessageSchemaField& schemaField(FanControl::SchemaField field);
...
#endif /// SIMPLE_FAN_CONTROL_META_H