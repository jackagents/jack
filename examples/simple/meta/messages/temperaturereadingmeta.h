#ifndef SIMPLE_TEMPERATURE_READING_META_H
#define SIMPLE_TEMPERATURE_READING_META_H
...
class TemperatureReading : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<TemperatureReading> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<TemperatureReading> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "TemperatureReading";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "simple.Temperature Reading";
    ...
    static const aos::jack::MessageSchemaField& schemaField(TemperatureReading::SchemaField field);
...
#endif /// SIMPLE_TEMPERATURE_READING_META_H