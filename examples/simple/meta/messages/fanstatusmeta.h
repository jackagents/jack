#ifndef SIMPLE_FAN_STATUS_META_H
#define SIMPLE_FAN_STATUS_META_H
...
class FanStatus : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<FanStatus> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<FanStatus> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "FanStatus";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "simple.Fan Status";
    ...
    static const aos::jack::MessageSchemaField& schemaField(FanStatus::SchemaField field);
...
#endif /// SIMPLE_FAN_STATUS_META_H