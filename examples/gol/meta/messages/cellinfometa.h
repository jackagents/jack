#ifndef GOL_CELL_INFO_META_H
#define GOL_CELL_INFO_META_H
...
class CellInfo : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<CellInfo> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<CellInfo> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "CellInfo";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "gol.Cell Info";
    ...
    enum SchemaField
    {
        SchemaField_cell_index,
        SchemaField_population,
        SchemaField_is_alive,
        SchemaField_COUNT
    };
    ...
    static const aos::jack::MessageSchemaField& schemaField(CellInfo::SchemaField field);
    ...
    struct JsonConfig : public aos::sim::JsonParsedComponent
    {
        ...
        int32_t cell_index = int32_t{0};
        int32_t population = int32_t{0};
        bool is_alive = false;
