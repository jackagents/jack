#ifndef GOL_CELL_COMMAND_META_H
#define GOL_CELL_COMMAND_META_H
...
class CellCommand : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<CellCommand> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<CellCommand> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "CellCommand";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "gol.Cell Command";
    ...
    static const aos::jack::MessageSchemaField& schemaField(CellCommand::SchemaField field);
